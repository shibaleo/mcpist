...
- [x] 空テンプレート 15 ファイル削除
- [x] dsn-module-registry.md が dsn-layers.md に統合され削除
- [x] dsn-modules.md が簡略化
- [x] dsn-layers.md が batch リファクタを反映
- [x] docs/ ファイル数が 160 未満（実績: 61 ファイル）
- [x] interaction/ 42 ファイル削除（計画外・追加実施）
- [x] details/ 重複 4 ファイル削除（計画外・追加実施）
