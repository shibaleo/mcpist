...
export const servicePlanRequirements: ServicePlanRequirement[] = [
  ...
  { serviceId: "google-drive", requiredPlan: "free" },
  { serviceId: "notion", requiredPlan: "free" },
  { serviceId: "github", requiredPlan: "free" },
  // Pro プラン
  { serviceId: "slack", requiredPlan: "pro" },
  { serviceId: "jira", requiredPlan: "pro" },
  { serviceId: "trello", requiredPlan: "pro" },
  { serviceId: "asana", requiredPlan: "pro" },
  // Max プラン
  { serviceId: "freee", requiredPlan: "max" },
  { serviceId: "zaim", requiredPlan: "max" },
  { serviceId: "moneytree", requiredPlan: "max" },
  { serviceId: "dropbox", requiredPlan: "max" },
]
...
export const toolPlanRequirements: ToolPlanRequirement[] = [
  ...
  // Slack
  { serviceId: "slack", toolId: "send-message", requiredPlan: "pro" },
  // Jira
  { serviceId: "jira", toolId: "list-issues", requiredPlan: "pro" },
  // Google Drive
  { serviceId: "google-drive", toolId: "list-files", requiredPlan: "free" },
  // freee
  { serviceId: "freee", toolId: "get-invoices", requiredPlan: "max" },
  // Zaim
  { serviceId: "zaim", toolId: "get-transactions", requiredPlan: "max" },
  // Dropbox
  { serviceId: "dropbox", toolId: "list-files", requiredPlan: "max" },
  // Trello
  { serviceId: "trello", toolId: "list-boards", requiredPlan: "pro" },
  // Asana
  { serviceId: "asana", toolId: "list-tasks", requiredPlan: "pro" },
  // Moneytree
  { serviceId: "moneytree", toolId: "get-accounts", requiredPlan: "max" },
]
...
export const billingHistory: BillingHistory[] = [
  { id: "1", date: "2026-01-15", plan: "Pro", amount: 2980, status: "paid" },
  { id: "2", date: "2025-12-15", plan: "Pro", amount: 2980, status: "paid" },
  { id: "3", date: "2025-11-15", plan: "Free", amount: 0, status: "paid" },
]
