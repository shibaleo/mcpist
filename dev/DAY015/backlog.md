...
Sprint-005継続。RPC呼び出しリファクタとOAuth認証モジュール実装を完了。
...
| B-009 | Microsoft To Do OAuth実装 | ✅ authorize/callback + Goモジュール (11ツール) |
| B-010 | services.json / tools.json更新 | ✅ Microsoft To Do追加 |
