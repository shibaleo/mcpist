...
| ID | タスク | Sprint ID | 備考 |
|----|--------|-----------|------|
| D18-001 | dtl-itr-DST-GWY.md レビュー | S6-017 | APIキー検証。store/api_keys.go との整合 |
| D18-002 | dtl-itr-DST-PSP.md レビュー | S6-017 | Webhook受信。Stripe実装前の仕様確認 |
| D18-003 | dtl-itr-DST-SSM.md レビュー | S6-017 | ユーザー情報登録・参照 |
| D18-004 | dtl-itr-DST-TVL.md レビュー | S6-017 | ユーザー紐付け |
| D18-005 | dtl-itr-GWY-OBS.md レビュー | S6-017 | HTTPリクエストログ。observability/loki.go 整合 |
...
- [ ] dtl-itr 全25件が reviewed（draft 0件）
