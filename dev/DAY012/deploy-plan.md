...
| 項目 | 値 |
|------|-----|
| Service URL | `REDACTED_PRIMARY_API_URL` |
...
1. wrangler.toml の production 環境を更新
   ...
   [env.production]
   vars = {
     PRIMARY_API_URL = "REDACTED_PRIMARY_API_URL",
     SECONDARY_API_URL = "REDACTED_URL",
...
| Render Health | `curl REDACTED_PRIMARY_API_URL/health` | 200 OK |
| Koyeb Health | `curl REDACTED_URL/health` | 200 OK |
...
| 変数 | 種別 | 値 |
|------|------|-----|
| `PRIMARY_API_URL` | var | `REDACTED_PRIMARY_API_URL` |
| `SECONDARY_API_URL` | var | `REDACTED_URL` |
