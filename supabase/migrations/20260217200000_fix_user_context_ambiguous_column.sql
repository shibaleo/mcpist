-- =============================================================================
-- Fix "column reference is ambiguous" in get_user_context
-- =============================================================================
-- RETURNS TABLE columns (user_id, email, etc.) become implicit PL/pgSQL
-- variables. Unqualified references to table columns with the same name
-- cause PostgreSQL error 42702. Fix: add table aliases to all affected queries.
-- =============================================================================
...
BEGIN
    ...
    WHERE ul.user_id = p_user_id
      AND ul.created_at >= (CURRENT_DATE AT TIME ZONE 'UTC');
