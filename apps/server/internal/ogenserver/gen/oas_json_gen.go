...
var jsonFieldsNameOfGenerateApiKeyBody = [4]string{
	0: "display_name",
	1: "name",
	2: "expires_in",
	3: "expires_at",
...
var jsonFieldsNameOfGenerateApiKeyResult = [8]string{
	0: "id",
	1: "api_key",
	2: "key",
	3: "key_prefix",
...
func (s *ModuleConfig) encodeFields(e *jx.Encoder) {
	...
	{
		if s.EnabledTools.Set {
			e.FieldStart("enabled_tools")
			s.EnabledTools.Encode(e)
		}
	}
}
...
func (s *ModuleConfig) Decode(d *jx.Decoder) error {
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "enabled_tools":
			if err := func() error {
				s.EnabledTools.Reset()
				if err := s.EnabledTools.Decode(d); err != nil {
					return err
				}
				return nil
			}(); err != nil {
...
var jsonFieldsNameOfOAuthApp = [8]string{
	0: "id",
	1: "provider",
	2: "client_id",
	3: "client_secret",
...
var jsonFieldsNameOfOAuthAppCredentials = [4]string{
	0: "provider",
	1: "client_id",
	2: "client_secret",
	3: "redirect_uri",
...
var jsonFieldsNameOfOAuthConsent = [3]string{
	0: "id",
	1: "module",
	2: "created_at",
}
...
var jsonFieldsNameOfOAuthConsentAdmin = [4]string{
	0: "id",
	1: "user_id",
	2: "module",
	3: "created_at",
...
var jsonFieldsNameOfPrompt = [10]string{
	0: "id",
	1: "user_id",
	2: "module_name",
	3: "module_id",
...
func (s *Prompt) Decode(d *jx.Decoder) error {
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "module_id":
			if err := func() error {
				s.ModuleID.Reset()
				if err := s.ModuleID.Decode(d); err != nil {
					return err
				}
				return nil
			}(); err != nil {
				return errors.Wrap(err, "decode field \"module_id\"")
			}
		case "name":
			requiredBitSet[0] |= 1 << 4
			if err := func() error {
...
var jsonFieldsNameOfUserProfile = [9]string{
	0: "id",
	1: "account_status",
	2: "plan_id",
	3: "display_name",
