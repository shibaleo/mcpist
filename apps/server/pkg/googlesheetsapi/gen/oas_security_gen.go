...
var operationRolesBearerAuth = map[string][]string{
	AppendValuesOperation:      []string{},
	BatchGetValuesOperation:    []string{},
	BatchUpdateOperation:       []string{},
	BatchUpdateValuesOperation: []string{},
	ClearValuesOperation:       []string{},
	CopySheetToOperation:       []string{},
	CreateSpreadsheetOperation: []string{},
	GetSpreadsheetOperation:    []string{},
	GetValuesOperation:         []string{},
	UpdateValuesOperation:      []string{},
}
