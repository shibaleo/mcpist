...
var operationRolesBearerAuth = map[string][]string{
	CreateRecordsOperation: []string{},
	CreateTableOperation:   []string{},
	DeleteRecordsOperation: []string{},
	GetRecordOperation:     []string{},
	ListBasesOperation:     []string{},
	ListRecordsOperation:   []string{},
	ListTablesOperation:    []string{},
	UpdateRecordsOperation: []string{},
	UpdateTableOperation:   []string{},
}
