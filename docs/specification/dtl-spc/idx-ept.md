...
| エンドポイント | メソッド | 用途 | 参照 |
|---------------|--------|------|------|
| `https://mcp.mcpist.app/mcp` | POST/GET | MCP Protocol (Streamable HTTP) | [itr-clt.md](../interaction/itr-clt.md#clt--srvmcp-server) |
| `https://mcp.mcpist.app/.well-known/oauth-protected-resource` | GET | Protected Resource Metadata (RFC 9728) | [itr-clt.md](../interaction/itr-clt.md#初回認可フローclt--srv--aus) |
...
| [itr-clt.md](../interaction/itr-clt.md) | MCP Client詳細仕様 |
