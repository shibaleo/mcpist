...
| ドキュメント | 内容 |
|-------------|------|
| [spc-sys.md](../specification/spc-sys.md) | システム仕様書 |
| [spc-itr.md](../specification/spc-itr.md) | インタラクション仕様書 |
| [idx-itr-rel.md](../specification/interaction/idx-itr-rel.md) | インタラクション関係ID一覧 |
